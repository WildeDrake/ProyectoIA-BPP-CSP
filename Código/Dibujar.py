...
def dibujar_seleccion(screen, objeto, objetoSeleccionado, conjObjetos, contenedor):
    ...
    #Flechas
    screen.blit(left, ((Global.WIDTH // 1.4 - Global.WIDTH // 20) - (Global.tamCasillas * (objeto.tamano()[1] + 2)) // 2, Global.HEIGHT // 2))
    screen.blit(right, ((Global.WIDTH // 1.4 + Global.WIDTH // 20) + (Global.tamCasillas * (objeto.tamano()[1] + 2)), Global.HEIGHT // 2))
